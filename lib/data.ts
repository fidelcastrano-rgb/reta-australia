...
export const faqs = [
  {
    ...
    "a": "We ship Australia-wide via Express Post. Orders placed before 2PM AEST are dispatched the same day."
  },
  {
    "q": "Are these products for human consumption?",
    "a": "Yes, these products are for human consumption."
  },
  {
    "q": "How should peptides be stored?",
    "a": "Store lyophilized powder in the freezer at -20°C for long-term stability. Once reconstituted, peptides must be refrigerated at 2-8°C and used within an appropriate timeframe."
  },
  {
    "q": "Do you provide Certificates of Analysis?",
    "a": "Yes, every batch we offer undergoes rigorous third-party testing. Certificates of Analysis (COA) for all products are available upon request. Simply reach out via WhatsApp or email to receive the full HPLC & MS report for your batch."
  },
  {
    "q": "What payment methods do you accept?",
    "a": "We accept Cryptocurrency (USDT, BTC, LTC - fast manual confirmation), PayID (orders of $100+), and Direct Bank Transfer (orders of $200+)."
  },
  {
